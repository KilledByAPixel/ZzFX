...
1),.5>a()?0:100*a()**3*(.5>a()?-1:1),0,0,0,.5>a()?0:3*a()**3,.5>a()?0:1E3*a()**4,.5>a()?0:5*a()**3,.5>a()?0:.5*a()**3);if(5==b.shape||.1>a())b.shapeCurve=100*a()**3;10<=b.shapeCurve&&(b.shapeCurve|=0);.5>a()&&(b.modulation*=-1);const c=b.attack+b.sustain+b.release;.5>a()&&(b.pitchJump=1E3*a()**2*(.5>a()?-1:1)|0,b.pitchJumpTime=a()*c);.5>a()&&(b.repeatTime=a()*c);return b}BuildSound(a=1,b=.05,c=220,f=0,m=0,n=.1,l=0,v=1,p=0,w=0,q=0,x=0,r=0,y=0,t=0,A=0,g=0){return{volume:a,randomness:b,frequency:c,attack:f,
