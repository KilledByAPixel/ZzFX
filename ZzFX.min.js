...
return b};
ZZFXLib.prototype.G=function(a){var c=this.r;this.r=a;for(var b=9;b--;)this.R();b={};b.seed=a;b.volume=1;b.randomness=a?this.randomness:0;b.frequency=a?50+2E3*Math.pow(this.R(),2)|0:220;b.frequencySlide=a?parseFloat((10*Math.pow(this.R(),3)).toFixed(1)):0;b.length=a?parseFloat((.1+this.R()).toFixed(1)):1;b.attack=a?parseFloat(this.R().toFixed(2)):.1;b.noise=a?parseFloat((5*Math.pow(this.R(),2)).toFixed(1)):0;b.modulation=a?parseFloat((10*Math.pow(this.R(),2)).toFixed(1)):0;b.modulationPhase=a?parseFloat(this.R().toFixed(2)):
0;this.r=c;return b};ZZFXLib.prototype.R=function(){this.r^=this.r<<13;this.r^=this.r>>7;this.r^=this.r<<17;return Math.abs(this.r)%1E9/1E9};var ZZFX=new ZZFXLib;