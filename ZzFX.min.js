...
return b};
ZZFXLib.prototype.G=function(a){var c=this.r;this.r=a;for(var b=9;b--;)this.R();b={};b.seed=a;b.volume=1;b.randomness=a?this.randomness:0;b.frequency=a?2E3*Math.pow(this.R(),2)|0:220;b.frequencySlide=a?parseFloat((10*Math.pow(this.R(),3)).toFixed(1)):0;b.length=a?parseFloat((.1+this.R()).toFixed(1)):1;b.attack=a?parseFloat(this.R().toFixed(2)):.1;b.noise=a?parseFloat((5*Math.pow(this.R(),2)).toFixed(1)):0;b.modulation=a?parseFloat((99*Math.pow(this.R(),3)).toFixed(1)):0;b.modulationPhase=a?parseFloat(this.R().toFixed(2)):
